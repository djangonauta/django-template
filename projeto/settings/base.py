...
env = environ.Env(
    ...
    DISABLE_ACCOUNT_REGISTRATION=(bool, True),
    AUTH_LDAP_SERVER_URI=(str, ""),
    AUTH_LDAP_USER_DN_TEMPLATE=(str, ""),
    ALLOWED_HOSTS=(list, ["*"]),
...
managers = env.dict("MANAGERS")

ADMINS = list(admins.items()) if isinstance(admins, dict) else []
MANAGERS = managers or ADMINS
...
DISABLE_ACCOUNT_REGISTRATION = env("DISABLE_ACCOUNT_REGISTRATION")
if DISABLE_ACCOUNT_REGISTRATION:
    ACCOUNT_ADAPTER = "projeto.apps.administrativo.usuarios.adapters.DisableSignupAdapter"
    REST_AUTH_REGISTER_SERIALIZERS = {
        "REGISTER_SERIALIZER": "projeto.apps.administrativo.usuarios.serializers"
        ".DisableSignupSerializer"
    }
